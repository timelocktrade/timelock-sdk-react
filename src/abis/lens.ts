    ...
    outputs: [
      {
        ...
        components: [
          {name: 'openingFeeRate', type: 'uint32', internalType: 'uint32'},
          {name: 'extensionFeeRate', type: 'uint32', internalType: 'uint32'},
          {name: 'minOpeningFee', type: 'uint128', internalType: 'uint128'},
          {name: 'minExtensionFee', type: 'uint128', internalType: 'uint128'},
    ...
    outputs: [
      {
        ...
        components: [
          ...
          {name: 'optionPricing', type: 'address', internalType: 'address'},
          {
            name: 'feeStrategy',
            type: 'address',
          ...
          {name: 'minPositionSize', type: 'uint256', internalType: 'uint256'},
          {name: 'maxPositionSize', type: 'uint256', internalType: 'uint256'},
          {name: 'owner', type: 'address', internalType: 'address'},
        ],
      },
    ],
    ...
    outputs: [
      {
        ...
        components: [
          ...
          {name: 'riskFreeRate', type: 'uint32', internalType: 'uint32'},
          {name: 'minPremiumDailyRate', type: 'uint32', internalType: 'uint32'},
          {name: 'minPremiumAmount', type: 'uint256', internalType: 'uint256'},
        ],
      },
    ],
    stateMutability: 'view',
    ...
    outputs: [
      {
        ...
        components: [
          {name: 'openingRate', type: 'uint32', internalType: 'uint32'},
          {name: 'dailyFundingRate', type: 'uint32', internalType: 'uint32'},
          {name: 'minOpeningAmount', type: 'uint128', internalType: 'uint128'},
          {name: 'minFundingAmount', type: 'uint128', internalType: 'uint128'},
        ],
      },
    ],
    stateMutability: 'view',
