export const optionsMarketAbi = [
  ...
  },
  {
    ...
    inputs: [],
    outputs: [
      {name: '', type: 'address', internalType: 'contract IFeeStrategy'},
    ],
    stateMutability: 'view',
  },
  {
    ...
    inputs: [
      ...
      {name: 'addedDuration', type: 'uint32', internalType: 'uint32'},
      {name: 'remainingDuration', type: 'uint32', internalType: 'uint32'},
      {name: 'priceFeedData', type: 'bytes', internalType: 'bytes'},
    ],
    outputs: [
      {name: 'premium', type: 'uint256', internalType: 'uint256'},
  ...
  },
  {
    ...
    inputs: [],
    outputs: [
      {name: '', type: 'address', internalType: 'contract TimelockGuardian'},
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {name: 'spendingApproval', type: 'uint256', internalType: 'uint256'},
    ],
    stateMutability: 'view',
  },
  {
  ...
  {
    type: 'function',
    name: 'setOperatorsPerms',
    inputs: [
      {name: 'operators', type: 'address[]', internalType: 'address[]'},
      {
        name: 'perms',
        type: 'tuple[]',
        internalType: 'struct TimelockOptionsMarket.OperatorPerms[]',
        components: [
          {name: 'canExtend', type: 'bool', internalType: 'bool'},
          {name: 'canExercise', type: 'bool', internalType: 'bool'},
          {name: 'canTransfer', type: 'bool', internalType: 'bool'},
  ...
  },
  {
    ...
    inputs: [
      ...
      {name: '_minPositionSize', type: 'uint256', internalType: 'uint256'},
      {name: '_maxPositionSize', type: 'uint256', internalType: 'uint256'},
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  {
    type: 'error',
    name: 'InvalidStrikeTick',
    inputs: [{name: 'strikeTick', type: 'int24', internalType: 'int24'}],
  },
  {
    type: 'error',
  ...
  },
  {
    ...
    inputs: [
      ...
      {name: 'amountExpected', type: 'uint256', internalType: 'uint256'},
    ],
  },
